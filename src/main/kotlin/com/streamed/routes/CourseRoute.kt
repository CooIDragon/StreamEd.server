    ...
    authenticate("jwt") {
            ...
            try {
                if (call.principal<UserModel>()!!.role != Roles.STUDENT) {
                    ...
                    call.respond(HttpStatusCode.OK,
                        BaseResponse(success = true, message = Constants.Success.COURSE_ADDED_SUCCESSFULLY))
                } else {
        ...
        post("api/v1/update-course") {
            ...
            try {
                ...
                call.respond(HttpStatusCode.OK, BaseResponse(success = true, message = Constants.Success.COURSE_UPDATE_SUCCESSFULLY))
            } catch (e: Exception) {
                call.respond(HttpStatusCode.Conflict, BaseResponse(false, e.message ?: Constants.Error.GENERAL))
            }
        }
        ...
        delete("api/v1/delete-course") {
            ...
            try {
                ...
                call.respond(HttpStatusCode.OK, BaseResponse(success = true, message = Constants.Success.COURSE_DELETED_SUCCESSFULLY))
            } catch (e: Exception) {
                call.respond(HttpStatusCode.Conflict, BaseResponse(false, e.message ?: Constants.Error.GENERAL))
            }
        }
